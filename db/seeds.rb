...
Store.create(name: 'Luises', address: 'Calle 61 25 #2', phone: '6495265036')
...
Store.create(name: 'Conasupo', address: 'Carrera 14 45', phone: '6495265042')
User.create(name: 'chapito', email: 'chapito@hotmail.com', password: 'chapito1', cellphone: '6495265014', store_id: 3)

Store.create(name: 'Prueba', address: 'Bogota', phone: '6495265014')
