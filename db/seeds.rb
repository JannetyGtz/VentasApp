...
Store.create(name: "Charritos", address: "Calle del Rayo 1452", phone: "6495265058") 
...
User.create(name: "Jannety", email: "jannetygtz@live.com", password: "jannety1", cellphone: "6495265020", store_id: 4)
User.create(name: "Ivan", email: "pablo-h-dz@hotmail.com", password: "ivan1", cellphone: "6495265020", store_id: 4)